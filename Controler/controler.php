...
===============================================================================*/
    ...
    public function registro()
    {
        ...
        $sql = "INSERT INTO `user` (email, username, password, repeat_password, role) VALUES (:email, :user, :pass, :pass2, :role)";
        ...
        if ($resultado) {
            $location = ($this->rol === 1) ? "Index_Promotor.html" : "Index_Cliente.html";
            header("Location: ../View/" . $location);
            exit();
        } else {
            // PDO usa errorInfo() en lugar de ->error
    ...
    public function actualizar($id) {
        ...
        $sql = "UPDATE `user` SET username = :user, email = :email WHERE id = :id";
        $stmt = $this->conexion->prepare($sql);
